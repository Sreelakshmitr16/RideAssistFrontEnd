...
export class RideService {
  ...
  getCustomers(){
    ...
    return this.http.get('http://127.0.0.1:8000/api/customers/',{'headers':this.getHeaders()})               //retuens observables
  }

  retrieveCustomer(id:any){
   
    return this.http.get(`http://127.0.0.1:8000/api/customers/${id}/`,{'headers':this.getHeaders()})     //instead of quotes:we use back ticks
  }
